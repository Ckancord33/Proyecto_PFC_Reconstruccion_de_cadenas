...
val (secuenciaIngenuo, nIngenuo, oIngenuo) = secuenciaRandom(1)
measure { reconstruirCadenaIngenuo(nIngenuo, oIngenuo) }

//Rendimiento de la funcion ingenua paralela
val (secuenciaIngenuo2, nIngenuo2, oIngenuo2) = secuenciaRandom(2)
measure { reconstruirCadenaIngenuoPar(1)(nIngenuo2, oIngenuo2) }
...
val (secMRend, nMRend, oMRend) = secuenciaRandom(2)
...
val (secTRend10, nTRend10, oTRend10) = secuenciaRandom(2)
